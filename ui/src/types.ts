...
export type WorkspaceView = 'conversations' | 'applications' | 'git' | 'documents' | 'design' | 'library' | 'routines' | 'fleet' | 'attention' | 'activity-report' | 'costs' | 'memory' | 'help' | 'progress' | 'dashboard' | 'settings'
