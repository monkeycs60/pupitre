...
Sur une page `localhost`, utiliser `Alt+Shift+S`, cliquer la zone et saisir la correction. Le panier flottant permet ensuite de choisir la branche, suivre les zones annotées et envoyer à Pupitre sans rouvrir l’extension.
