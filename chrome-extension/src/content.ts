...
.marker{position:fixed;width:24px;height:24px;margin:-12px 0 0 -12px;border:2px solid white;border-radius:50%;background:#d94f32;color:white;font:700 12px/20px ui-sans-serif,system-ui,sans-serif;text-align:center;box-shadow:0 2px 6px rgba(0,0,0,.3);pointer-events:auto;cursor:help}.marker.focused{width:28px;height:28px;margin:-14px 0 0 -14px;line-height:24px;background:#bd3f27}
